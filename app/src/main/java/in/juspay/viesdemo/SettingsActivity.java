...
public class SettingsActivity extends AppCompatActivity {
    ...
    @Binding private Spinner betaAssets;
    ...
    private void resetFields() {
        ...
        if (Preferences.useBetaAssets.equalsIgnoreCase("true")){
            betaAssets.setSelection(0);
        } else {
            betaAssets.setSelection(1);
        }
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        if (item.getItemId() == R.id.saveIcon) {
            ...
            if(betaSelected == 0) {
                Preferences.useBetaAssets = "true";
            }
            else {
                Preferences.useBetaAssets = "false";
            }
