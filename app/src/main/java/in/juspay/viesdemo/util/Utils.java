...
public final class Utils {
    ...
    public static JSONObject createGpayTxnApi(Context context, String orderId, String amount, String cardNumber, String cardExpMonth, String cardExpYear, String cardCvv, String cardAlias) {
        final String url = "/txns";
        ...
        payload.put(PaymentConstants.MERCHANT_ID, Preferences.merchantId);
        payload.put("payment_method_type", "WALLET");
        payload.put("format", "json");
        payload.put("redirect_after_payment", "true");
        payload.put("payment_method", "GOOGLEPAY");
        payload.put("sdk_params", "true");
