...
public class Preferences {
    ...
    public static String useBetaAssets = "false";

    static String clientId = merchantId + "_android";
    ...
    static void readPrefs(Context context) {
        ...
        try {
            ...
            useBetaAssets = json.optString("useBetaAssets", useBetaAssets);
    ...
    static void writePrefs(Context context) {
        ...
        try {
            ...
            json.put("useBetaAssets", useBetaAssets);
